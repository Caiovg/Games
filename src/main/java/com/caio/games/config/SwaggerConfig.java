...
public class SwaggerConfig {
	...
	private static Contact contact() {
		return new Contact("Caio Vinicius Gonçalves", "https://github.com/Caiovg/Games.git",
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Loja de Games").description("Projeto API Spring - Loja de Games")
				...
				.licenseUrl("https://github.com/Caiovg/Games.git").contact(contact()).build();
	}
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.caio.games.controller"))
